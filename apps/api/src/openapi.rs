...
#[allow(unused_imports)]
use crate::handlers::ha_sso::{__path_ha_callback, __path_ha_start};
#[allow(unused_imports)]
...
#[openapi(
    ...
    components(schemas(
        ...
        crate::handlers::retirement_profile::CoastMode,
        crate::handlers::retirement_profile::PartialStartMode,
        ...
        crate::handlers::transactions::PendingAssignment,
