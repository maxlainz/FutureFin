...
**Las DOS cifras de ahorro de `financial_health`** — sobreviven a la limpieza de 3.9.0 y son distintas a propósito. Confundirlas desplaza una respuesta ~14 % (issue #7 §1):
...
- **4.0.0** — `update_categorization_rule` + `delete_categorization_rule`
  ...
  movimientos pero no corregirla, y las reglas contradictorias se acumulaban (issue #8 §10). Las dos
