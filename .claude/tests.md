...
grep -c "#\[tokio::test\]" apps/api/tests/*.rs | awk -F: '{s+=$2} END {print s}'
                                        # 283 en 27 suites a 2026-08-19 (transactions_reconcile.rs aporta 19)
