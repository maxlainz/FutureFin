...
pub use needed_capital::{
    ...
    NeededCapital, ABSENT_ALREADY_COVERED, ABSENT_MONTH_BEYOND_HORIZON,
    ...
    MAX_LAMBDA_DOUBLINGS, MAX_LAMBDA_HALVINGS, WARM_LAMBDA_BISECTION_DRAWS, WARM_LAMBDA_FLOOR,
};
