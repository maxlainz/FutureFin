...
9. **Multi-usuario:** login propio; modelo en `docs/spec/AUTH_MODEL.md` (multi-hogar recomendado MVP, roles owner/member/viewer, sin privacidad por persona entre miembros en v1).
